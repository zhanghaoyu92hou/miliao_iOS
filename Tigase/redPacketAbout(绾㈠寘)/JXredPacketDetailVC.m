//
//  MiXin_JXredPacketDetail_MiXinVC.m
//  shiku_im
//
...
#import "MiXin_JXredPacketDetail_MiXinVC.h"
#import "JXRPacketListCell.h"
#import "JXRedPacketListVC.h"

@interface MiXin_JXredPacketDetail_MiXinVC () <UITextViewDelegate>
...
@implementation MiXin_JXredPacketDetail_MiXinVC
...
- (void)creatTBHeaderView{
    ...
    _returnMoneyLabel.text = [NSString stringWithFormat:@"%@(%.2f%@)%@",Localized(@"MiXin_JXredPacketDetail_MiXinVC_ReturnMoney1"),_packetObj.over,Localized(@"JX_ChinaMoney"),Localized(@"MiXin_JXredPacketDetail_MiXinVC_ReturnMoney2")];
...
- (void)setViewData{
    ...
    _totalMoneyLabel.text = [NSString stringWithFormat:@"%@%.2f%@",Localized(@"MiXin_JXredPacketDetail_MiXinVC_All"),_packetObj.money,Localized(@"JX_ChinaMoney")];
    ...
    if([over doubleValue] < 0.01){
        isCanOpen = Localized(@"MiXin_JXredPacketDetail_MiXinVC_DrawOver");
    }else if(_dataDict[@"resultMsg"]){
        isCanOpen = Localized(@"MiXin_JXredPacketDetail_MiXinVC_Overdue");
        [self creatTBHeaderView];
    }else if ([_OpenMember count] < _packetObj.count && _dataDict[@"resultMsg"] == nil) {
        isCanOpen = Localized(@"MiXin_JXredPacketDetail_MiXinVC_DrawOK");
    }
    if (_packetObj.over < 0.01) {
        _showNumLabel.text = [NSString stringWithFormat:@"%@%ld/%ld,%@",Localized(@"MiXin_JXredPacketDetail_MiXinVC_Drawed"),[_OpenMember count],_packetObj.count,isCanOpen];
    }else{
        _showNumLabel.text = [NSString stringWithFormat:@"%@%ld/%ld, %@%.2f%@,%@",Localized(@"MiXin_JXredPacketDetail_MiXinVC_Drawed"),[_OpenMember count],_packetObj.count,Localized(@"MiXin_JXredPacketDetail_MiXinVC_Rest"),_packetObj.over,Localized(@"JX_ChinaMoney"),isCanOpen];
    }
