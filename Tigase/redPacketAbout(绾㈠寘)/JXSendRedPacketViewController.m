//
//  MiXin_JXSendRedPacket_MiXinViewController.m
//  shiku_im
//
...
#import "MiXin_JXSendRedPacket_MiXinViewController.h"
#import "JXTopSiftJobView.h"
#import "JXRedInputView.h"
#import "MiXin_JXRecharge_MiXinViewController.h"
#import "MiXin_JXVerifyPay_MiXinVC.h"
#import "MiXin_JXPayPassword_MiXinVC.h"

#define TopHeight 40

@interface MiXin_JXSendRedPacket_MiXinViewController ()<UITextFieldDelegate,UIScrollViewDelegate,RechargeDelegate>
...
@property (nonatomic, strong) MiXin_JXVerifyPay_MiXinVC * verVC;
...
@implementation MiXin_JXSendRedPacket_MiXinViewController
...
-(void)sendRedPacket:(UIButton *)button{
    ...
    if (500 >= [_moneyText floatValue]&&[_moneyText floatValue] > 0) {
        ...
        if ([g_server.myself.isPayPassword boolValue]) {
            self.verVC = [MiXin_JXVerifyPay_MiXinVC alloc];
            ...
            MiXin_JXPayPassword_MiXinVC *payPswVC = [MiXin_JXPayPassword_MiXinVC alloc];
...
-(void)rechargeButtonAction{
    MiXin_JXRecharge_MiXinViewController * rechargeVC = [[MiXin_JXRecharge_MiXinViewController alloc]init];
