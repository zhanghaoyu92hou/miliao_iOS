...
#import "MiXin_JXRecordCode_MiXinVC.h"
#import "JXRecordTBCell.h"
@interface MiXin_JXRecordCode_MiXinVC ()

@end

@implementation MiXin_JXRecordCode_MiXinVC
- (instancetype)init
{
    self = [super init];
    if (self) {
...
- (void)customView{
    ...
    self.title = Localized(@"MiXin_JXRecordCode_MiXinVC_Title");
