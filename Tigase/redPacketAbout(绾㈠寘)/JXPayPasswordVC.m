...
@interface MiXin_JXPayPassword_MiXinVC () <UITextFieldDelegate>
...
@implementation MiXin_JXPayPassword_MiXinVC
...
//        [g_navigation popToViewController:[JXMoneyMenuViewController class] animated:YES];
        [g_navigation popToViewController:[MiXin_JXMyMoney_MiXinViewController class] animated:YES];
    }
    else if (self.enterType == JXEnterTypeWithdrawal){
        [g_navigation popToViewController:[MiXin_JXCashWithDraw_MiXinViewController class] animated:YES];
    }
