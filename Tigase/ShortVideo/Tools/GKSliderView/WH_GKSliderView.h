...
@protocol WH_GKSliderViewDelegate <NSObject>

@optional
// 滑块滑动开始
- (void)WH_sliderTouchBegan:(float)value;
// 滑块滑动中
- (void)WH_sliderValueChanged:(float)value;
// 滑块滑动结束
- (void)WH_sliderTouchEnded:(float)value;
// 滑杆点击
- (void)WH_sliderTapped:(float)value;

@end

@interface WH_GKSliderView : UIView

@property (nonatomic, weak) id<WH_GKSliderViewDelegate> delegate;
