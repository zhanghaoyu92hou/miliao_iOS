...
#import "MiXin_AnimOperation.h"
#define KScreenWidth [[UIScreen mainScreen] bounds].size.width

@interface MiXin_AnimOperation ()
...
@implementation MiXin_AnimOperation

@synthesize finished = _finished;
@synthesize executing = _executing;

+ (instancetype)MiXin_AnimOperationWithUserID:(NSString *)userID model:(GiftModel *)model finishedBlock:(void(^)(BOOL result,NSInteger finishCount))finishedBlock; {
    MiXin_AnimOperation *op = [[MiXin_AnimOperation alloc] init];
