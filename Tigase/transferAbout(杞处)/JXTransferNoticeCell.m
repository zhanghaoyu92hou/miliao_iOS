//
//  MiXin_JXTransferNotice_MiXinCell.m
//  shiku_im
//
...
#import "MiXin_JXTransferNotice_MiXinCell.h"
#import "JXTransferNoticeModel.h"
#import "MiXin_JXTransferModel.h"

@interface MiXin_JXTransferNotice_MiXinCell ()
...
@implementation MiXin_JXTransferNotice_MiXinCell
...
- (void)setDataWithMsg:(JXMessageObject *)msg model:(id)tModel {
    if ([msg.type intValue] == kWCMessageTypeTransferBack) {
        MiXin_JXTransferModel *model = (MiXin_JXTransferModel *)tModel;
