//
//  MiXin_JXPay_MiXinViewController.m
//  shiku_im
//
...
@interface MiXin_JXPay_MiXinViewController ()
...
@implementation MiXin_JXPay_MiXinViewController
...
- (void)setupViews {
    self.tableBody.backgroundColor = HEXCOLOR(0x00ceb3);
