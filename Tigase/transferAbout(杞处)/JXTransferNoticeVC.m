//
//  MiXin_JXTransferNotice_MiXinVC.m
//  shiku_im
//
...
@interface MiXin_JXTransferNotice_MiXinVC ()
@property (nonatomic, strong) NSArray *array;

@end

@implementation MiXin_JXTransferNotice_MiXinVC
...
//    SBJsonParser * OderJsonwriter = [SBJsonParser new];
    ...
    if ([msg.type intValue] == kWCMessageTypeTransferBack) {
        MiXin_JXTransferModel *model = [[MiXin_JXTransferModel alloc] init];
