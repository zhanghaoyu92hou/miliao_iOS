//
//  MiXin_JXTransferDeatil_MiXinVC.m
//  shiku_im
//
...
#import "MiXin_JXTransferDeatil_MiXinVC.h"
#import "MiXin_JXTransferModel.h"
...
@interface MiXin_JXTransferDeatil_MiXinVC () <UIAlertViewDelegate>

@property (nonatomic, assign) JXTransferDeatilType type;
@property (nonatomic, strong) MiXin_JXTransferModel *model;
...
@implementation MiXin_JXTransferDeatil_MiXinVC
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.model = [[MiXin_JXTransferModel alloc] init];
...
//        MiXin_JXMyMoney_MiXinViewController *moneyVC = [[MiXin_JXMyMoney_MiXinViewController alloc] init];
...
//    MiXin_JXMessageObject *msg = noti.object;
    // 收到收钱消息，获取当前时间并刷新界面
