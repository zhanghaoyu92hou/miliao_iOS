...
enum kWCMessageType {
    ...
    kWCMessageTypeMultipleGetUserInfo = 2000,  // 更新用户信息 并通知其他端

};

@class FMResultSet;
@class MiXin_JXImageView;
...
@interface MiXin_JXMessageObject : NSObject<NSCopying>
//以下字段用于通讯,message里：
...
//@property (nonatomic,strong) NSNumber*  isOpenReadDel;// 开启阅后即焚多久消失
...
//-(void)downloadFile:(MiXin_JXImageView*)iv;//下载文件
