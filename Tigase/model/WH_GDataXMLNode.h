...
#ifdef WH_GDataXMLNode_DEFINE_GLOBALS
#define _EXTERN
...
typedef NSUInteger WH_GDataXMLNodeKind;

@interface WH_GDataXMLNode : NSObject {
@protected
  ...
  // later when adding the node to a tree with WH_addChild: or addAttribute:.
...
@interface GDataXMLElement : WH_GDataXMLNode
...
- (WH_GDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
