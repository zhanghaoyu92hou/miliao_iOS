...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.wh_heightHeader = _locationType ==JXGooLocationTypeShowStaticLocation ? 0 : JX_SCREEN_TOP;
...
//            UIButton* btn = [UIFactory WH_create_WHButtonWithImage:@"title_more" highlight:nil target:self selector:@selector(moreBtnAction)];
