...
@interface JXLocationVC : WH_admob_WHViewController<BMKMapViewDelegate,BMKLocationServiceDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate,UITableViewDelegate,UITableViewDataSource>{
