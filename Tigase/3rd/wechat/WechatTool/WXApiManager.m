...
- (void)onResp:(BaseResp *)resp
{
    ...
    if([resp isKindOfClass:[PayResp class]]){
        ...
        [g_notify postNotificationName:kWxPayFinish_WHNotification object:resp];
...
//    }
    ...
    if ([resp isKindOfClass:[SendAuthResp class]]) {
        self.isHandlerThirdLoginCallback = NO;
        [g_notify postNotificationName:kWxSendAuthResp_WHNotification object:resp];
    }
}
