...
+(void)sortAndGroup:(NSArray*)objectArray
    ...
    if (key == nil) {
        ...
        containKey = ((NSDictionary *)obj)[key] ? YES : NO;
    } else {
        NSObject *obj = objectArray.firstObject;
        unsigned int outCount, i;
        Ivar *ivars;
        if ([obj isKindOfClass:[WH_JXUserObject class]] && ![obj isKindOfClass:[JXDevice class]]) {
...
+(BMChineseSortModel*)getModelWithObj:(id)obj key:(NSString*)key{
    ...
    if (!key) {
        ...
        if ([obj isKindOfClass:[WH_JXUserObject class]] || [obj isKindOfClass:[JXDevice class]]) {
            model.string = [(WH_JXUserObject *)obj remarkName].length > 0 ? [(WH_JXUserObject *)obj remarkName] : [(WH_JXUserObject *)obj userNickname];
