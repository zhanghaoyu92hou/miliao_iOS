...
- (BOOL)start:(NSError **)errPtr
{
	...
	[query WH_addChild:[NSXMLElement elementWithName:@"username" stringValue:username]];
	[query WH_addChild:[NSXMLElement elementWithName:@"resource" stringValue:resource]];
	[query WH_addChild:[NSXMLElement elementWithName:@"password" stringValue:password]];
