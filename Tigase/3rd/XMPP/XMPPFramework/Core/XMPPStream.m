...
#if DEBUG
  static const int xmppLogLevel = XMPP_LOG_LEVEL_ERROR; // | XMPP_LOG_FLAG_TRACE;
#else
...
- (BOOL)registerWithElements:(NSArray *)elements error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
        ...
        {
            [queryElement WH_addChild:element];
        }
