...
- (void)setLocation:(CLLocation *)geo {
	...
	if (geo != nil) {
		...
		if (elem == nil) {
			...
			[elem WH_addChild:lat];
			lon = [NSXMLElement elementWithName:@"LON"];
			[elem WH_addChild:lon];
		} else {
	...
	if (elem != nil) {
		...
		switch (privacyClass) {
			case XMPPvCardTempClassPublic:
				[elem WH_addChild:[NSXMLElement elementWithName:@"PUBLIC"]];
				break;
			case XMPPvCardTempClassPrivate:
				[elem WH_addChild:[NSXMLElement elementWithName:@"PRIVATE"]];
				break;
			case XMPPvCardTempClassConfidential:
				[elem WH_addChild:[NSXMLElement elementWithName:@"CONFIDENTIAL"]];
				break;
			default:
