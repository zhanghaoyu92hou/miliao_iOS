...
{
	[privacyItem WH_addChild:[NSXMLElement elementWithName:@"iq"]];
}

+ (void)blockMessages:(NSXMLElement *)privacyItem
{
	[privacyItem WH_addChild:[NSXMLElement elementWithName:@"message"]];
}

+ (void)blockPresenceIn:(NSXMLElement *)privacyItem
{
	[privacyItem WH_addChild:[NSXMLElement elementWithName:@"presence-in"]];
}

+ (void)blockPresenceOut:(NSXMLElement *)privacyItem
{
	[privacyItem WH_addChild:[NSXMLElement elementWithName:@"presence-out"]];
}
