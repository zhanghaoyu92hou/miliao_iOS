...
{
	[self WH_addChild:[NSXMLElement elementWithName:@"active" xmlns:ChatStatesXmlns]];
}

- (void)addComposingChatState
{
	[self WH_addChild:[NSXMLElement elementWithName:@"composing" xmlns:ChatStatesXmlns]];
}

- (void)addPausedChatState
{
	[self WH_addChild:[NSXMLElement elementWithName:@"paused" xmlns:ChatStatesXmlns]];
}

- (void)addInactiveChatState
{
	[self WH_addChild:[NSXMLElement elementWithName:@"inactive" xmlns:ChatStatesXmlns]];
}

- (void)addGoneChatState
{
	[self WH_addChild:[NSXMLElement elementWithName:@"gone" xmlns:ChatStatesXmlns]];
}
