...
- (void)sendSIOfferAcceptance:(XMPPIQ *)offer
{
  ...
  dispatch_block_t block = ^{
      @autoreleasepool {
        ...
        [field WH_addChild:value];
        [x WH_addChild:field];
        [feature WH_addChild:x];
        [si WH_addChild:feature];
        [iq WH_addChild:si];
...
- (void)attemptStreamhostsConnection:(XMPPIQ *)iq
{
  ...
  dispatch_block_t block = ^{
      @autoreleasepool {
        ...
        [errorElem WH_addChild:notAcceptable];
        [errorIq WH_addChild:errorElem];
...
- (void)socks5ReadReply:(NSData *)incomingData
{
  ...
  dispatch_block_t block = ^{
      @autoreleasepool {
        ...
        [query WH_addChild:streamhostUsed];
        [iq WH_addChild:query];
