...
@interface WH_RATableView () <UITableViewDelegate>

@end


@implementation WH_RATableView
...
{
  if ([self.scrollViewDelegate respondsToSelector:@selector(WH_scrollViewDidEndDecelerating:)]) {
