...
#import "MiXin_Organiz_MiXinObject.h"
#import "JXUserObject.h"

@implementation MiXin_Organiz_MiXinObject
...
-(void)setChildren:(NSArray *)children{
    if ([children[0] isKindOfClass:[MiXin_Organiz_MiXinObject class]]) {
        _children = children;
        return;
    }
    NSMutableArray *childArray = [NSMutableArray array];
    for (NSDictionary * childDict in children) {
        MiXin_Organiz_MiXinObject * organiz = [MiXin_Organiz_MiXinObject organizObjectWithDict:childDict];
