...
#import "WH_KKDrawTool.h"

@implementation WH_KKDrawTool{
...
- (UIImage*)widthSliderBackground
{
    ...
    UIColor *color = [[[WH_KKImageEditorTheme theme] toolbarTextColor] colorWithAlphaComponent:0.5];
...
- (void)setMenu
{
    ...
    _strokePreview.layer.borderColor = [[[WH_KKImageEditorTheme theme] toolbarTextColor] CGColor];
...
- (void)strokePreviewDidTap:(UITapGestureRecognizer*)sender
{
    ...
    if(_eraserIcon.hidden){
        ...
        _strokePreview.backgroundColor = [[WH_KKImageEditorTheme theme] toolbarTextColor];
        _strokePreviewBackground.backgroundColor = _strokePreview.backgroundColor;
    }
}
