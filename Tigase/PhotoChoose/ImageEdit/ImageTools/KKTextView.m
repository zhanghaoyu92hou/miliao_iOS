...
- (id)initWithTool:(KKTextTool*)tool
{
    ...
    if(self){
        ...
        _label.font = [UIFont fontWithName:@"PingFangSC-Semibold" size: 25];
...
//        _label.textAlignment = NSTextAlignmentCenter;
        ...
        [_deleteButton setImage:[UIImage imageNamed:@"WH_Image_Text_Close"] forState:UIControlStateNormal];
