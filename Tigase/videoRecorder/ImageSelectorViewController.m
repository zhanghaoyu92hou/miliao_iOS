//
//  MiXin_ImageSelector_MiXinViewController.m
//  shiku_im
//
...
#import "MiXin_ImageSelector_MiXinViewController.h"
#import "MiXin_ImageSelector_MiXinCollectionCell.h"

static NSString* const imageSelectCellID = @"imageSelectCellID";

@interface MiXin_ImageSelector_MiXinViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
...
@implementation MiXin_ImageSelector_MiXinViewController
...
//    [layout release];
    ...
    [_collectionView registerClass:[MiXin_ImageSelector_MiXinCollectionCell class] forCellWithReuseIdentifier:imageSelectCellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    MiXin_ImageSelector_MiXinCollectionCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:imageSelectCellID forIndexPath:indexPath];
...
-(void)didImageView:(UIView*)sender{
    ...
    MiXin_ImageSelector_MiXinCollectionCell * cell = (MiXin_ImageSelector_MiXinCollectionCell*)[_collectionView cellForItemAtIndexPath:indexPath];
