...
#import "MiXin_JXCaptureMedia.h"
#import "MiXin_JXImageView.h"


@implementation MiXin_recordVideo_MiXinViewController
@synthesize delegate;
...
//    [_recordLabel release];
    ...
    _close = [[MiXin_JXImageView alloc]initWithFrame:CGRectMake(52, _recrod.frame.origin.y, 31, 31)];
...
//    [_close release];
    ...
    _save = [[MiXin_JXImageView alloc]initWithFrame:CGRectMake(JX_SCREEN_WIDTH-_close.frame.origin.x-_close.frame.size.width, _close.frame.origin.y, 31, 31)];
...
//    [_save release];
    ...
    _flash = [[MiXin_JXImageView alloc]initWithFrame:CGRectMake(16, 10, 30, 30)];
...
//    [_flash release];
    ...
    _flashOn = [[MiXin_JXImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_flash.frame)+20, CGRectGetMinY(_flash.frame), 30, 30)];
...
//    [_flashOn release];
    ...
    _flashOff = [[MiXin_JXImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_flashOn.frame)+20, CGRectGetMinY(_flash.frame), 30, 30)];
...
//    [_flashOff release];
    ...
    _cammer = [[MiXin_JXImageView alloc]initWithFrame:CGRectMake(JX_SCREEN_WIDTH-16-30, CGRectGetMinY(_flash.frame), 30, 27)];
...
- (void)initCapture{
    _capture = [[MiXin_JXCaptureMedia alloc]init];
...
- (void)dealloc {
    NSLog(@"MiXin_recordVideo_MiXinViewController.dealloc");
...
- (void)onSave{
    ...
    if(_isShowSaveImage && [_capture.outputImageFiles count]){
        MiXin_ImageSelector_MiXinViewController * imageSelectVC = [[MiXin_ImageSelector_MiXinViewController alloc] init];
...
-(void)noticeLabelHidden:(BOOL)hide textType:(int)type{
    ...
    switch (type) {
        case 1:
            ...
            break;
        case 2:
            showStr = [NSString stringWithFormat:@"%@%ds",Localized(@"MiXin_recordVideo_MiXinViewController_LessThan"),_minTime];
            break;
        default:
            break;
    }
