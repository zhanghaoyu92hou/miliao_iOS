...
- (void)customSearchTextField{
    ...
    _seekTextField.placeholder = [NSString stringWithFormat:@"%@", (_type == JXSelUserTypeRoomTransfer)?@"搜索联系人":Localized(@"JX_SearchChatLog")];
    _seekTextField.backgroundColor = g_factory.inputBackgroundColor;
    if (@available(iOS 10, *)) {
        _seekTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@", (_type == JXSelUserTypeRoomTransfer)?@"搜索联系人":Localized(@"JX_SearchChatLog")] attributes:@{NSForegroundColorAttributeName:g_factory.inputDefaultTextColor}];
    } else {
