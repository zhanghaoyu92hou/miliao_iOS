//
//  MiXin_JXSearchUserList_MiXinVC.m
//  shiku_im
//
...
#import "MiXin_JXSearchUserList_MiXinVC.h"
#import "JXNearCell.h"
#import "MiXin_JXUserInfo_MiXinVC.h"

@interface MiXin_JXSearchUserList_MiXinVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>{
...
@implementation MiXin_JXSearchUserList_MiXinVC
- (id)init
{
    self = [super init];
    if (self) {
