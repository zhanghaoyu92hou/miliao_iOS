...
@interface MiXin_JXSearchUser_MiXinVC ()<UITextFieldDelegate>

@end

@implementation MiXin_JXSearchUser_MiXinVC
...
- (id)init
{
    ...
    if (self) {
        ...
        if (self.type == JXSearchTypeUser) {
            self.title = Localized(@"MiXin_JXNear_MiXinVC_AddFriends");
        }else {
        ...
        int h = 0;
        _values = [[NSMutableArray alloc]initWithObjects:Localized(@"MiXin_JXSearchUser_MiXinVC_AllDate"),Localized(@"MiXin_JXSearchUser_MiXinVC_OneDay"),Localized(@"MiXin_JXSearchUser_MiXinVC_TwoDay"),Localized(@"MiXin_JXSearchUser_MiXinVC_ThereDay"),Localized(@"MiXin_JXSearchUser_MiXinVC_OneWeek"),Localized(@"MiXin_JXSearchUser_MiXinVC_TwoWeek"),Localized(@"MiXin_JXSearchUser_MiXinVC_OneMonth"),Localized(@"MiXin_JXSearchUser_MiXinVC_SixWeek"),Localized(@"MiXin_JXSearchUser_MiXinVC_TwoMonth"),nil];
...
//        NSString* city = [g_constant getAddressForNumber:g_myself.provinceId cityId:g_myself.cityId areaId:g_myself.areaId];
        ...
        iv.frame = CGRectMake(0, h, JX_SCREEN_WIDTH, HEIGHT);
        _sex = [self createLabel:iv default:Localized(@"MiXin_JXSearchUser_MiXinVC_All")];
        h+=iv.frame.size.height;
        
        iv = [self createButton:Localized(@"MiXin_JXSearchUser_MiXinVC_MinAge") drawTop:NO drawBottom:YES must:NO click:nil];
        iv.frame = CGRectMake(0, h, JX_SCREEN_WIDTH, HEIGHT);
        _minAge = [self createTextField:iv default:@"0" hint:Localized(@"MiXin_JXSearchUser_MiXinVC_MinAge")];
        h+=iv.frame.size.height;
        
        iv = [self createButton:Localized(@"MiXin_JXSearchUser_MiXinVC_MaxAge") drawTop:NO drawBottom:YES must:NO click:nil];
        iv.frame = CGRectMake(0, h, JX_SCREEN_WIDTH, HEIGHT);
        _maxAge = [self createTextField:iv default:@"200" hint:Localized(@"MiXin_JXSearchUser_MiXinVC_MaxAge")];
        h+=iv.frame.size.height;
        
        iv = [self createButton:Localized(@"MiXin_JXSearchUser_MiXinVC_AppearTime") drawTop:NO drawBottom:YES must:NO click:@selector(onDate)];
        iv.frame = CGRectMake(0, h, JX_SCREEN_WIDTH, HEIGHT);
...
-(void)dealloc{
//    NSLog(@"MiXin_JXSearchUser_MiXinVC.dealloc");
    self.job = nil;
//    [super dealloc];
}
...
-(void)onSex{
    ...
    vc.values = [NSMutableArray arrayWithObjects:Localized(@"MiXin_JXSearchUser_MiXinVC_All"),Localized(@"JX_Man"),Localized(@"JX_Wuman"),nil];
    vc.selNumber = 0;
