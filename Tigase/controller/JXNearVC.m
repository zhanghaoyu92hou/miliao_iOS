...
@interface MiXin_JXNear_MiXinVC () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,JXActionSheetVCDelegate>
{
...
@implementation MiXin_JXNear_MiXinVC
...
- (void)viewDidLoad
{
    ...
    if (!_isSearch) {
        ...
        self.title = Localized(@"MiXin_JXNear_MiXinVC_NearHere");
    }else {
    ...
    //        UIButton* btn = [UIFactory createButtonWithTitle:Localized(@"MiXin_JXNear_MiXinVC_AddFriends") titleFont:[UIFont systemFontOfSize:15] titleColor:[UIColor whiteColor] normal:nil highlight:nil];
    ...
    btn = [UIFactory createButtonWithRect:CGRectMake(JX_SCREEN_WIDTH-50, JX_SCREEN_TOP - 38, 40, 30) title:Localized(@"JX_Screening") titleFont:SYSFONT(16) titleColor:nil normal:nil selected:nil selector:@selector(onScreening) target:self];
    btn.custom_acceptEventInterval = 1.0f;
    //        UIButton* btn = [UIFactory createButtonWithTitle:Localized(@"MiXin_JXNear_MiXinVC_AddFriends") titleFont:[UIFont systemFontOfSize:15] titleColor:[UIColor whiteColor] normal:nil highlight:nil];
    //        [btn addTarget:self action:@selector(onSearch) forControlEvents:UIControlEventTouchUpInside];
    [self.tableHeader addSubview:btn];
...
- (void) customView {
    ...
    _topSiftView.dataArray = [[NSArray alloc] initWithObjects:Localized(@"MiXin_JXNear_MiXinVC_NearPer"),Localized(@"MiXin_JXNear_MiXinVC_Map"), nil];
    //Localized(@"MiXin_JXNear_MiXinVC_NewPer")
...
- (void)dealloc {
//    NSLog(@"MiXin_JXNear_MiXinVC.dealloc");
//    [_search release];
