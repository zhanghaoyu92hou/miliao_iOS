...
@class WH_JXLocPerImage_WHVC;
@interface WH_JXLocMap_WHVC : UIViewController<UIScrollViewDelegate>{
    ATMHud * _wait;
}
...
@property (nonatomic,strong) WH_JXLocPerImage_WHVC * lastAnnotationView;//上次被选择的大头针
