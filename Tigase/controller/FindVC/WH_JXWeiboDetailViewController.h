//
//  WH_JXWeiboDetailViewController.h
//  Tigase
//
...
@class WH_JXWeiboDetailViewController;
@protocol weiboDVCDelegate <NSObject>

- (void) weiboVC:(WH_JXWeiboDetailViewController *)weiboVC didSelectWithData:(WeiboData *)data;

@end

NS_ASSUME_NONNULL_BEGIN

@interface WH_JXWeiboDetailViewController : WH_JXTableViewController<WH_HBCoreLabelDelegate,UITextFieldDelegate>
{
    JXTextView* _input;
...
@property (nonatomic, weak) id<weiboDVCDelegate>delegate;
