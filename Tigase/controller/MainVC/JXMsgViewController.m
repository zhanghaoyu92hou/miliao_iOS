...
//    [self.tableHeader addSubview:scanButton];
    ...
    self.moreBtn = [UIFactory createButtonWithImage:@"im_003_more_button_normal"
                                           highlight:nil
                                              target:self
    ...
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, JX_SCREEN_TOP, JX_SCREEN_WIDTH, 60)];
...
//    [backView addSubview:cancelBtn];
    ...
    _seekTextField = [[UITextField alloc] initWithFrame:CGRectMake(15, 12, backView.frame.size.width - 32, 36)];
    _seekTextField.placeholder = [NSString stringWithFormat:@"%@", Localized(@"JX_SearchChatLog")];
    _seekTextField.backgroundColor = HEXCOLOR(0xF2F3F6);
    _seekTextField.textColor = HEXCOLOR(0x969696);
    _seekTextField.layer.borderWidth = 0.5;
    _seekTextField.layer.borderColor = HEXCOLOR(0xE9E9E9).CGColor;
    [_seekTextField setFont:SYSFONT(17)];
...
//    CGRect moreFrame = [self.tableHeader convertRect:self.moreBtn.frame toView:window];
    ...
    NSMutableArray *images = [NSMutableArray arrayWithArray:@[@"icon_group_chat_entry", @"icon_face_to_face", @"icon_add_friend", @"icon_scan", @"icon_payment_received",@"message_near_receiving",@"message_search_publicNumber"]];
