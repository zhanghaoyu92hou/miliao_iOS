...
//    [backView addSubview:cancelBtn];
    ...
    _seekTextField = [[UITextField alloc] initWithFrame:CGRectMake(15, 12, backView.frame.size.width - 30, 36)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    titleLbl.textColor = HEXCOLOR(0x666666);
    titleLbl.font = [UIFont fontWithName:@"PingFangSC-Medium" size: 13];
