...
@property (nonatomic, assign) CGFloat wh_previousTextViewContentHeight;
@property (nonatomic, weak) id    wh_target;
@property (nonatomic, assign) SEL	didTouch;
@property (nonatomic, assign) BOOL  wh_disableAutoSize;
@property (nonatomic, assign) BOOL  wh_isEditing;
 ...
 *  标语文本的颜色
 */
@property (nonatomic, strong) UIColor *wh_placeHolderTextColor;
