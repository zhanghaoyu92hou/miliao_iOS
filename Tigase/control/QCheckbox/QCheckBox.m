...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setBackgroundImage:[UIImage imageNamed:@"WH_addressbook_unselected"] forState:UIControlStateNormal];
        [self setBackgroundImage:[UIImage imageNamed:@"WH_addressbook_selected"] forState:UIControlStateSelected];
